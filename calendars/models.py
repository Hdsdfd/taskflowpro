...
class Teamcalendars(models.Model):
    """
    团队日历模型
    """
    ...
    # 所属团队/项目
    project = models.ForeignKey(Project, on_delete=models.CASCADE, null=True, blank=True, related_name='team_calendarss', verbose_name='关联项目')
    
    # 权限设置
    is_public = models.BooleanField(default=False, verbose_name='是否公开')
    can_edit = models.ManyToManyField(User, blank=True, related_name='editable_calendarss', verbose_name='可编辑用户')
    can_view = models.ManyToManyField(User, blank=True, related_name='viewable_calendarss', verbose_name='可查看用户')
