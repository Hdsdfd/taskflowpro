        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="editable_calendarss",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="可编辑用户",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="viewable_calendarss",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="可查看用户",
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="calendars_ca_start_t_ec8af5_idx",
                    ),
                    models.Index(
                        fields=["creator", "start_time"],
                        name="calendars_ca_creator_709354_idx",
                    ),
                ],
            },
        ),
